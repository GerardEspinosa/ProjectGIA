...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 09-03-2022 a las 17:11:34
...
CREATE TABLE `clientes` (
  ...
  `Provincia_Cliente` varchar(45) COLLATE latin1_spanish_ci NOT NULL,
  `Ciudad_Cliente` varchar(45) COLLATE latin1_spanish_ci NOT NULL,
  `Direccion_Cliente` varchar(45) COLLATE latin1_spanish_ci NOT NULL,
  `Fecha_Nacimineto_Cliente` date NOT NULL,
